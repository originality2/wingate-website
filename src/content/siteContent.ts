...
const child_with_bucket = `${cloudfrontImgBase}/child_with_bucket.jpg`;
const people_drawings = `${cloudfrontImgBase}/people_drawings.jpg`;
const child_with_sand = `${cloudfrontImgBase}/child_with_sand.jpg`;
const farmers_market = `${cloudfrontImgBase}/farmers_market.jpg`;
const play_corner = `${cloudfrontImgBase}/play_corner.jpg`;
const table_playdough_setting = `${cloudfrontImgBase}/table_playdough_setting.jpg`;
const seeds_empty_room = `${cloudfrontImgBase}/seeds_empty_room.jpg`;
const seedlings_empty_room = `${cloudfrontImgBase}/seedlings_empty_room.jpg`;
const seedlings_empty_room_2 = `${cloudfrontImgBase}/seedlings_empty_room_2.jpg`;
const child_gardening = `${cloudfrontImgBase}/child_gardening.jpg`;
const child_on_playground = `${cloudfrontImgBase}/child_on_playground.jpg`;
const resources = `${cloudfrontImgBase}/resources.jpg`;
const many_people_drawing = `${cloudfrontImgBase}/many_people_drawing.jpg`;
const outdoor_play_area = `${cloudfrontImgBase}/outdoor_play_area.jpg`;
const tower_of_hanoi = `${cloudfrontImgBase}/tower_of_hanoi.jpg`;
